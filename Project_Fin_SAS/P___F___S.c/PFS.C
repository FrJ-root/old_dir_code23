...
void ModifyTache(){
    int i, id, idtrouver, choix;
    char NV_Statut, NV_Deadline;
    ...
    {
    case 1 :
        printf("Veuiller Entrer id de Tache : ");
        scanf("%d",&id);
        printf("\n");
        for(i=0; i<T_Number ; i++)
        {
...
int main(){
    ...
    {
        Menu();
        printf("Choisissez une option : ");scanf("%d", &choix);
        switch (choix)
        {
        case 1:
            system("cls");
